    ...
    children: [
      {
        ...
        children: [
          {
            path: 'home',
            loadComponent: () => import('./provider/pages/provider-home/provider-home.page').then(m => m.ProviderHomePage)
          },
          {
            path: 'bookings',
            loadComponent: () => import('./provider/pages/provider-bookings/provider-bookings.page').then(m => m.ProviderBookingsPage)
          },
          {
            path: 'inbox',
            loadComponent: () => import('./provider/pages/provider-inbox/provider-inbox.page').then(m => m.ProviderInboxPage)
          },
          {
            path: 'profile',
            loadComponent: () => import('./provider/pages/provider-profile/provider-profile.page').then(m => m.ProviderProfilePage)
          },
          {
